...
async def lifespan(app: FastAPI):
    global gateway
    gateway = Gateway(
        llm_api_key="4f65b3c3-d1bd-4535-9902-0ae9baf08b4d",
        ...
        <div class="settings-panel" id="settings-panel">
            ...
            <div class="card">
                ...
                <div style="font-size: 14px; color: #8b949e; line-height: 1.8;">
                    <div><strong style="color: #e6edf3;">模型:</strong> Doubao Seed 1.8</div>
                    <div><strong style="color: #e6edf3;">Endpoint:</strong> https://ark.cn-beijing.volces.com/api/v3</div>
                </div>
            </div>
            <div class="card">
...
async def process_chat(websocket, session_id):
    for turns in range(5):
        ...
        if not response.tool_calls:
            final = response.content or "抱歉，我没有理解你的问题。"
