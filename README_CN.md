...
[![Version](https://img.shields.io/badge/version-0.6.4.4.2-blue)](https://github.com/LK-BLOG/PyClaw/)
...
将整个 `PyClaw/` 文件夹复制到 USB 驱动器中，插入任何 Linux 或 macOS 机器，并在终端中运行 `./start.sh`。PyClaw 完全从 USB 驱动器运行——不会写入系统，不会在主机上留下配置文件，拔出 USB 时就会消失。

**非常适合：**
- 在公共或借用的计算机上使用您的 AI 助手
- 随身携带您的配置和历史记录
- 快速演示而不污染他人的系统
---
