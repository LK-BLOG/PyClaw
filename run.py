...
def install_dependencies():
    ...
    print()
    print("[HINT] 提示：如果你的 Python 是 3.14（很新），建议改用 Python 3.11 或 3.12")
...
def main():
    ...
    if allow_external:
        ...
        print("OK: 仅本机访问（加 --allow-external 开放局域网）")
    ...
    print()
    print("OK: 启动成功！")
    print(f"[WEB] 本机访问: http://localhost:2469")
    ...
    if allow_external == 'Y':
        ...
        try:
            ...
            s.close()
            print(f"[WEB] 局域网访问: http://{local_ip}:2469")
        except OSError:
            pass
